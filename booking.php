...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo"> <a href="index.html"><img src="logo.png" width="70px"></a> </div>
            <ul class="menu">
    ...
    <section class="services" id="services">
        <div class="max-width">
            <h2 class="title">Book Your Free Consultation Now !</h2>
            <div class="form">
                <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd_jZUHd8aKv8Si6x0lQDC43tlHpVTH1gaCO_YJSk91MIl_4A/viewform?embedded=true" width="640" height="800" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
            </div>
        </div>
    </section>
