    ...
    <section class="featured">       
        <div class="home-article">
            <div class="home-article-img">
                <img class="cover" src="./images/civilcode.jpg" alt="article">
            </div>
            <div class="home-article-content">
                <a href="blog-uniform-civil-code.html">
                    <h3>Uniform Civil Code : Abstract or Feasible</h3>
                </a>
    
                <div class="authorname">Chandan Choudhary</div>
                <span>07 June | 10 min read</span>
            </div>
        </div>
        <div class="home-article">
            <div class="home-article-img">
                <img class="cover" src="./images/whatisnotlaw.jpg" alt="article" >
            </div>
            <div class="home-article-content">
                <a href="blog-what-is-not-law.html">
                    <h3>What Is and What Not Is Law!</h3>
                </a>
    
                <div class="authorname">Chandan Choudhary</div>
                <span>07 June | 2 min read</span>
            </div>
        </div>
